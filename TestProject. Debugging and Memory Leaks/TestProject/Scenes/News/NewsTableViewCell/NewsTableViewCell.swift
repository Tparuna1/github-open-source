...
import UIKit
import Kingfisher  // არ იყო დაიმპორტებული


final class NewsTableViewCell: UITableViewCell {
    //UICollectionViewCell იყო გაწერილი UITableViewCell ის ნაცვლად
    ...
    private var newsTitleLabel: UILabel = {
        ...
        label.isHidden = false // true - იყო მონიშნული. 
        return label
    }()
